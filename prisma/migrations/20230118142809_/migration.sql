...
-- CreateTable
CREATE TABLE "UserPeference" (
    "id" TEXT NOT NULL,
    "emailUpdates" BOOLEAN NOT NULL,
    "userId" TEXT NOT NULL,

    CONSTRAINT "UserPeference_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "UserPeference_userId_key" ON "UserPeference"("userId");
...
-- AddForeignKey
ALTER TABLE "UserPeference" ADD CONSTRAINT "UserPeference_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
